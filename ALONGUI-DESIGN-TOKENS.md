...
暂时使用 Apple 经典蓝，可自定义覆盖。

```css
--al-color-primary:          #0071e3;  /* 主色 */
--al-color-primary-hover:    #47a3ff;  /* hover */
--al-color-primary-light:    #b8d8ff;  /* 浅色背景 */
--al-color-primary-dark:     #0058b3;  /* active / pressed */
```
